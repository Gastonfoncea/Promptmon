...
// Fuente display con presencia para títulos/headings (PRO-25).
...
// Fuente poster ultra-bold para el hero de la landing.
const anton = Anton({
...
export const metadata: Metadata = {
  title: "PromptMon",
  description: "Pokémon que dibujás con palabras, en Monad.",
};
